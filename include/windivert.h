...
extern WINDIVERTEXPORT BOOL WinDivertHelperParsePacket(
    __in        PVOID pPacket,
    __in        UINT packetLen,
    __out_opt   WINDIVERT_IPHDR *ppIpHdr,
    __out_opt   WINDIVERT_IPV6HDR *ppIpv6Hdr,
    __out_opt   WINDIVERT_ICMPHDR *ppIcmpHdr,
    __out_opt   WINDIVERT_ICMPV6HDR *ppIcmpv6Hdr,
    __out_opt   WINDIVERT_TCPHDR *ppTcpHdr,
    __out_opt   WINDIVERT_UDPHDR *ppUdpHdr,
...
extern WINDIVERTEXPORT UINT WinDivertHelperCalcChecksums(
    ...
    __in        UINT packetLen,
    __in_opt    WINDIVERT_ADDRESS* pAddr,
    __in        UINT64 flags);
